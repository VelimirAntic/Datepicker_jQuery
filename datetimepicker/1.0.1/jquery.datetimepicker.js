...
(function( $ ){
	$.fn.datetimepicker = function( opt ){
		...
		var createDateTimePicker = function( input ){
			...
			datetimepicker.bind('mousedown',function( event ){
			...
			mounth_picker.find('.xdsoft_prev,.xdsoft_next').mousedown(function(){
				...
				$(window).bind('mouseup',function(){
					clearTimeout(timer);
					stop = true;
					$(this).bind('mouseup',arguments.callee);
				});
			});
			...
			datetimepicker.bind('change.xdsoft',function(){
			...
			datetimepicker.bind( 'open.doksoft',function(){
			...
			calendar.delegate('td', 'mousedown',function(){
			...
			timebox.delegate( 'div','mousedown',function(){
				if($(this).hasClass('xdsoft_disabled'))
					return false;
				var ct = datetimepicker.data('xdsoft_datetime').currentTime;
			...
			input.data( 'xdsoft_datetimepicker',datetimepicker )
				.bind('enter keyup mousedown open.xdsoft',function(event){
